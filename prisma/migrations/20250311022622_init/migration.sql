...
-- CreateIndex
CREATE INDEX "shifts_id_sede_idx" ON "shifts"("id_sede");
...
-- AddForeignKey
ALTER TABLE "shifts" ADD CONSTRAINT "shifts_id_sede_fkey" FOREIGN KEY ("id_sede") REFERENCES "sedes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
